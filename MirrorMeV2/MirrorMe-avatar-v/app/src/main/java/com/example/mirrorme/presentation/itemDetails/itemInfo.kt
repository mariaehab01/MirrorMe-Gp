...
import com.example.mirrorme.presentation.auth.ProfileViewModel
...
fun ItemInfoScreen(productId: Int, navController: NavHostController,cartViewModel: CartViewModel ) {
    ...
    val profile = profileViewModel.profileUiState
    val profileIsLoading = profileViewModel.isLoading
    val profileErrorMessage = profileViewModel.errorMessage
    ...
    val colors = listOf<Color>(Color.Red, Color.Green, Color.Blue, Color.Yellow, Color.Magenta, Color.Cyan, Color.Gray)
    ...
    LaunchedEffect(productId) {
        ...
        profileViewModel.loadProfile() // Load user profile data
                    ...
                    ActionButtons(
                        onTryOn = {
                            navController.navigate(
                                "webView/${profile?.height}/${profile?.weight}/${profile?.gender}/${profile?.body_shape}/${profile?.skin_tone}"
                            )
                        },
                        onAddToBag = {
...
//                     -------- Suggestions Scrollable --------
                    ...
                    if (showOutfitContainer) {
                        ...
                        ScrollableRowWithArrows(
                            ...
                            onScrollChange = { outfitScrollStart=it },
                            boxColor = Color.Gray,
